...
class EmployeeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('employee')->insert([
            ...
            ['name'=>'Rosni Lumbantoruan, ST, M.ISD,Ph.D','user_id'=>5,'role'=>"5;59",'created_at'=>now()],
            ['name'=>'Humasak Tommy Argo Simanjuntak, ST, M.ISD','user_id'=>6,'role'=>"6;59",'created_at'=>now()],
            ['name'=>'Mariana Simanjuntak, S.S, M.Sc','user_id'=>7,'role'=>19,'created_at'=>now()],
            ['name'=>'Indra Hartarto Tambunan, ST., M.S.,Ph.D','user_id'=>8,'role'=>"44;58",'created_at'=>now()],
            ...
            ['name'=>'Parmonangan Rotua Togatorop, S.Kom., M.T.I','user_id'=>12,'role'=>"13;59",'created_at'=>now()],
            ['name'=>'Arie Satia Dharma, S.T, M.Kom','user_id'=>13,'role'=>"48;57",'created_at'=>now()],
            ['name'=>'Samuel Indra Gunawan Situmeang, S.Ti., M.Sc.','user_id'=>14,'role'=>"50;59",'created_at'=>now()],
            ['name'=>'Guntur Purba Siboro, S.T, M.T','user_id'=>15,'role'=>"49;58",'created_at'=>now()],
            ...
            ['name'=>'Junita Amalia, S.Pd, M.Si','user_id'=>31,'role'=>"9;59",'created_at'=>now()],
