...
class createRole extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('roles')->insert([
            ...
            ['role' => 'WR 1', 'status' => true, 'is_admin' => false, 'atasan_id' => 2, 'required_to_submit_document' => 3],
            ['role' => 'WR 2', 'status' => true, 'is_admin' => false, 'atasan_id' => 2, 'required_to_submit_document' => null],
            ['role' => 'WR 3', 'status' => true, 'is_admin' => false, 'atasan_id' => 2, 'required_to_submit_document' => null],
            ...
            ['role' => 'Ketua SPM', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Staff SPM', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Ketua SPI', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Staff SPI', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Ketua LPPM', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Staff LPPM', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Direktur Pendidikan', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ...
            ['role' => 'Member of Lembaga Kemahasiswaaan', 'status' => true, 'is_admin' => false, 'atasan_id' => 7, 'required_to_submit_document' => null],
            ...
            ['role' => 'Dekan Fakultas Informatika dan Teknik Elektro', 'status' => true, 'is_admin' => false, 'atasan_id' => 2, 'required_to_submit_document' => null],
            ['role' => 'Dekan Fakultas Teknologi Industri', 'status' => true, 'is_admin' => false, 'atasan_id' => 2, 'required_to_submit_document' => null],
            ['role' => 'Dekan Fakultas Bioteknologi', 'status' => true, 'is_admin' => false, 'atasan_id' => 2, 'required_to_submit_document' => null],
            ['role' => 'Dekan Fakultas Vokasi', 'status' => true, 'is_admin' => false, 'atasan_id' => 2, 'required_to_submit_document' => null],
            ['role' => 'Ketua Program Studi S1 Informatika', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Ketua Program Studi S1 Elektro', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Ketua Program Studi S1 Sistem Informasi', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Ketua Program Studi S1 Manajemen Rekayasa', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Ketua Program Studi S1 Teknik Metalurgi', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Ketua Program Studi S1 Teknik Bioproses', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Ketua Program Studi D3 Teknik Informasi', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Ketua Program Studi D3 Teknik Komputer', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Ketua Program Studi D4 Teknologi Rekayasa Perangkat Lunak', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
