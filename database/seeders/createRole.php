...
class createRole extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('roles')->insert([
            ...
            ['role' => 'BAAK', 'status' => true, 'is_admin' => false, 'atasan_id' => 4, 'required_to_submit_document' => '1'],
            ['role' => 'PPKHA', 'status' => true, 'is_admin' => false, 'atasan_id' => 4, 'required_to_submit_document' => '1'],
            ['role' => 'Ketua GJM', 'status' => true, 'is_admin' => false, 'atasan_id' => 2, 'required_to_submit_document' => '1'],
            ['role' => 'Anggota GJM', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Ketua GKM', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => '1'],
            ['role' => 'Anggota GKM', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Ketua SPM', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => "1;2"],
            ['role' => 'Staff SPM', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Ketua SPI', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => "1;2"],
            ['role' => 'Staff SPI', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Ketua LPPM', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => "1;3;4"],
            ['role' => 'Staff LPPM', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Direktur Pendidikan', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => "1;3"],
            ['role' => 'Member of Direktorat Kemitraan dan Hubungan Masyrakat', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => '1'],
            ['role' => 'Member of BAA', 'status' => true, 'is_admin' => false, 'atasan_id' => 7, 'required_to_submit_document' => null],
            ['role' => 'Member of Keamanan dan QA', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => '1'],
            ['role' => 'Member of Lembaga Kemahasiswaaan', 'status' => true, 'is_admin' => false, 'atasan_id' => 7, 'required_to_submit_document' => "1;3"],
            ['role' => 'Member of Pusat Pembinaan Keasramaan', 'status' => true, 'is_admin' => false, 'atasan_id' => 7, 'required_to_submit_document' => '1'],
            ...
            ['role' => 'Member of SDI', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => '1'],
            ['role' => 'Member of Divisi Infastruktur ', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Member of UPT PP ESTEM', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => '1'],
            ['role' => 'Member of SAM', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => null],
            ['role' => 'Member of Perpustakaan', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => '1'],
            ['role' => 'Member of UPT Bahasa', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => '1'],
            ...
            ['role' => 'Member of Logistik', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => '1'],
            ['role' => 'Member of Keuangan', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => '1'],
            ['role' => 'Member of Biro Administrasi Umum', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => '1'],
            ...
            ['role' => 'Member of Pusat Inovasi dan Kewirausahaan', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => '1'],
            ...
            ['role' => 'Ketua Program Studi S1 Informatika', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => "1;3;4"],
            ['role' => 'Ketua Program Studi S1 Elektro', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => "1;3;4"],
            ['role' => 'Ketua Program Studi S1 Sistem Informasi', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => "1;3;4"],
            ['role' => 'Ketua Program Studi S1 Manajemen Rekayasa', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => "1;3;4"],
            ['role' => 'Ketua Program Studi S1 Teknik Metalurgi', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => "1;3;4"],
            ['role' => 'Ketua Program Studi S1 Teknik Bioproses', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => "1;3;4"],
            ['role' => 'Ketua Program Studi D3 Teknik Informasi', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => "1;3;4"],
            ['role' => 'Ketua Program Studi D3 Teknik Komputer', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => "1;3;4"],
            ['role' => 'Ketua Program Studi D4 Teknologi Rekayasa Perangkat Lunak', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => "1;3;4"],
            ...
            ['role' => 'GJM', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => '1'],
            ['role' => 'GKM', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => '1'],
        ]);
    }
}
