...
class createRole extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('roles')->insert([
            ...
            ['role' => 'WR 2', 'status' => true, 'is_admin' => false, 'atasan_id' => 2, 'required_to_submit_document' => 3],
            ['role' => 'WR 3', 'status' => true, 'is_admin' => false, 'atasan_id' => 2, 'required_to_submit_document' => 3],
            ...
            ['role' => 'Ketua LPPM', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => 3],
            ...
            ['role' => 'Ketua Program Studi S1 Manajemen Rekayasa', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => 3],
            ['role' => 'Ketua Program Studi S1 Teknik Metalurgi', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => 3],
            ['role' => 'Ketua Program Studi S1 Teknik Bioproses', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => 3],
            ['role' => 'Ketua Program Studi D3 Teknik Informasi', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => 3],
            ['role' => 'Ketua Program Studi D3 Teknik Komputer', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => 3],
            ['role' => 'Ketua Program Studi D4 Teknologi Rekayasa Perangkat Lunak', 'status' => true, 'is_admin' => false, 'atasan_id' => null, 'required_to_submit_document' => 3],
