...
class Dokumen extends Seeder
{
    ...
    public function run(): void
    {
        for ($i = 0; $i < 10; $i++) {
            ...
            $documentData = [
                [
                    'name' => 'Laporan Pemerintah ' . ($i + 1),
                    'nama_dokumen' => 'Laporan_Pemerintah' . ($i + 1) . '.pdf',
                    ...
                    'tipe_dokumen' => '1',
                    'parent' => '1',
                    'set_date' => Carbon::now()->format('Y-m-d H:i:s'),
                ...
                [
                    'name' => 'Statua IT Del ' . ($i + 1),
                    'nama_dokumen' => 'Statua_ITdel' . ($i + 1) . '.pdf',
                    'nomor_dokumen' => 'DOC00' . ($i + 1),
                    'deskripsi' => 'Deskripsi dokumen ' . ($i + 1),
                    'directory' => '/src/documents/dokumen_' . ($i + 1) . '.pdf',
                    'give_access_to' => '0;1;2;3',
