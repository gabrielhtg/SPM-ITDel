                                        ...
                                        <div class="row justify-content-center mb-4">
                                            ...
                                            @foreach($similarDocuments as $similarDocument)
                                                @if($similarDocument->status != 'Berlaku')
                                                    <li class="mb-4">
                                                        <a href="{{ route('viewdocumentdetail', ['id' => $similarDocument->id]) }}" style="font-size: 18px; color: #087cfc; font-weight: 500;">{{$similarDocument->nama_dokumen}}</a>
                                                        <span style="font-size: 18px;">{{$similarDocument->description}}</span>
                                                        <br><span>{{$similarDocument->status}}</span>
                                                    </li>
                                                @endif
                                            @endforeach
