                    ...
                    <div class="card card-primary card-outline" style="min-height: 80vh">
                        <div class="card-body box-profile d-flex flex-column justify-content-center">
                            ...
                            <p class="text-muted text-center">
                                {{ app(AllServices::class)->convertRole(auth()->user()->role) }}</p>
                            <div class="d-flex justify-content-center">
                                <ul class="list-group list-group-unbordered mb-3" style="width: 500px">
                                    <li class="list-group-item" style="padding-left: 10px; padding-right: 10px">
                                        <b>Nama Pengguna</b> <span
                                            class="float-right">{{ auth()->user()->username }}</span>
                                    </li>
                                    <li class="list-group-item" style="padding-left: 10px; padding-right: 10px">
                                        <b>Nomor Telepon</b> <span
                                            class="float-right">{{ auth()->user()->phone }}</span>
                                    </li>
                                    <li class="list-group-item" style="padding-left: 10px; padding-right: 10px">
                                        <b>Alamat Email</b> <span
                                            class="float-right">{{ auth()->user()->email }}</span>
                                    </li>
                                    <li class="list-group-item" style="padding-left: 10px; padding-right: 10px">
                                    ...
                                    <li class="list-group-item" style="padding-left: 10px; padding-right: 10px">
                                        ...
                                        @else
                                            <b>Berakhir Pada</b> <span class="float-right">-</span>
                                        @endif
                                    </li>
                                    <li class="list-group-item" style="padding-left: 10px; padding-right: 10px">
