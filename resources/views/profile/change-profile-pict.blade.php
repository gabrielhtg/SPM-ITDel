        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="card card-primary card-outline d-flex flex-column align-items-center justify-content-center"
                        style="height: 80vh">

                        <div class="d-flex justify-content-center mt-4">
                            <div style="width: 500px; min-width: 300px; height: 300px;">
                                <img id="image" src="{{ asset('src/img/default-profile-pict.png') }}"
                                    alt="gambar" style="height: 200px">
                            </div>
                        </div>
                    ...
                    error: function(jqXHR, status, error) {
                        if (jqXHR.status === 413) {
                            ...
                            sessionStorage.setItem('text',
                                'File yang anda unggah terlalu besar. Harap unggah file yang lebih kecil dari 2 MB.'
                                );
                            window.location.href = '{{ route('change-profile-pict') }}';
                        } else {
                            sessionStorage.setItem('success', "0");
