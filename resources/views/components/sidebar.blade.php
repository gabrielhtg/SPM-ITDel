...
=======
                     ...
                     <li class="nav-item">
                     <a href="{{ route('dashboard-laporan') }}" class="nav-link {{ $active_sidebar[1] ?? 0 ? 'active' : '' }}">
...
>>>>>>> a77833742324c6a3ebfa2bc276b88ee9137b9982
                <li class="nav-item">
                    <a href="{{ route('indexlogindashboard') }}"
                        class="nav-link {{ $active_sidebar[0] == 2 ? 'active' : '' }}">
                        <i class="nav-icon fas fa-tachometer-alt"></i>
                        <p>
                            Admin Dashboard
                        </p>
                    ...
                    <li class="nav-item {{ $active_sidebar[0] == 5 ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @if (app(AllServices::class)->haveAccountable(auth()->user()->role) ||
                                    app(AllServices::class)->isLoggedUserHasAdminAccess(auth()->user()->role))
                                <li class="nav-item">
                            ...
                            @php
                                $isResponsible =
                                    app(AllServices::class)->isResponsible(auth()->user()->role) ||
                                    app(AllServices::class)->isAccountable(auth()->user()->role) ||
                                    app(AllServices::class)->isInformable(auth()->user()->role);
                            @endphp
