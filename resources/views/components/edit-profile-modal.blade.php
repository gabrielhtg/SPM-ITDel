    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-register" method="POST" action="{{ route('edit-profile') }}">
                    ...
                    <div class="input-group mt-3">
                        ...
                        <select id="edit-profile" name="roles[]" class="form-control" multiple="multiple" style="width: 100%;" required>
                            @php
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="submit" form="form-register" class="btn btn-primary"><i class="far fa-save mr-1"></i>Simpan</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
