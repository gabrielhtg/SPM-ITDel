...
!function (t, e) {
    ...
    var _t = function (t, e) {
            ...
            !function (t, e) {
                ...
                if (n && o) {
                    ...
                    ut(o, "padding", e.padding), e.color && (o.style.color = e.color), e.background && (o.style.background = parseURL(e.background)), lt(N()), Wt(o, e)
                }
    ...
    function he(t, e, n, o) {
        G() ? ke(t, o) : (b(n).then((function () {
            return ke(t, o)
        })), Xt(g)), ue ? (e.setAttribute("style", "display:none !important"), e.removeAttribute("class"), e.innerHTML = parseHTML("")) : e.remove(), X() && (null !== pe && (document.body.style.paddingRight = "".concat(pe, "px"), pe = null), function () {
